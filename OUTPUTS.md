...
| Fahrzeug         | PB4  | Heizung 2         | System   | Nein     |
| STM32            | PB7  | LED Green         | Komfort  | Ja       |
| Fahrzeug         | PB11 | F54               | System   | Nein     |
| Fahrzeug         | PB12 | F18               | System   | Nein     |
| Fahrzeug         | PB13 | Klima Out         | System   | Nein     |
| STM32            | PB14 | LED Blue          | Komfort  | Ja       |
| ASR              | PC3  | WS2812 LED        | Komfort  | Ja       |
| Fahrzeug         | PD3  | Ladeleuchte       | Komfort  | Nein     |
| Fahrzeug         | PD7  | Öltemp            | Komfort  | Ja       |
| Fahrzeug         | PD9  | Bremslicht        | Komfort  | Nein     |
| Fahrzeug         | PD11 | Rücklicht         | Komfort  | Nein     |
| Fahrzeug         | PD13 | Klima PWM Out     | System   | Nein     |
| Fahrzeug         | PD14 | Anhänger          | Komfort  | Ja       |
| Fahrzeug         | PD15 | Reserve           | Komfort  | Ja       |
| Fahrzeug         | PE0  | Heizung 1         | System   | Nein     |
| Fahrzeug         | PE1  | Digital 2         | Komfort  | Nein     |
| Fahrzeug         | PE2  | Digital 1         | Komfort  | Nein     |
| Fahrzeug         | PE7  | Glühkerzenrelais  | Komfort  | Nein     |
| Shutdown Circuit | PE15 | Motorsteuergerät  | System   | Ja       |
| Fahrzeug         | PF2  | Öldruck           | Komfort  | Nein     |
| Board Computer   | PF3  | Down Out          | Komfort  | Ja       |
| Board Computer   | PF4  | Up Out            | Komfort  | Ja       |
| Board Computer   | PF5  | Reset Out         | Komfort  | Ja       |
| Bamocar          | PF12 | Bamo Out 1        | Komfort  | Nein     |
| Bamocar          | PF13 | Bamo Out 2        | Komfort  | Nein     |
| Fahrzeug         | PF14 | J317              | System   | Nein     |
| DCDC             | PF15 | Enable            | System   | Nein     |
| Fahrzeug         | PG2  | Buzzer            | System   | Ja       |
| Fahrzeug         | PG3  | Generator LED     | System   | Nein     |
| Fahrzeug         | PG9  | Wischwarn         | Komfort  | Ja       |
| Fahrzeug         | PG10 | Bremswarn         | Komfort  | Ja       |
| Fahrzeug         | PG11 | Pumpe Bremse      | System   | Ja       |
| Fahrzeug         | PG13 | Pumpe Kühlung     | System   | Nein     |
| Fahrzeug         | PG14 | Lüfter 2          | System   | Nein     |
| Fahrzeug         | PG15 | Lüfter 1          | System   | Nein     |
...
### Anzeigezeiten Kombiinstrument
 
Einige Komfortausgänge steuern Warnleuchten im Kombiinstrument an. Diese haben
fahrzeugspezifische Anzeigezeiten, die bei der Programmierung berücksichtigt werden müssen:
 
| Funktion         | Anzeigedauer | Löschdauer |
|:-----------------|:------------:|:----------:|
| Bremswarn        | 1 s          | 2 s        |
| Rücklichtwarnung | 2 s          | 2 s        |
| Wischwarn        | 20 s         | 20 s       |