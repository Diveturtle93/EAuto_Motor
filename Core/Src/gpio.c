...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : DIGITAL1_Pin GLUEHKERZEN_Pin MOTOR_SDC_OUT_Pin HEATER1_Pin
                           DIGITAL2_Pin */
  ...
  /*Configure GPIO pins : ECO_Pin BC_DOWN_IN_Pin DURCHFLUSS_Pin BUTTON2_Pin
  ...
  /*Configure GPIO pins : PC14 PC15 PC0 PC1
                           PC2 SD_SW_Pin SD_D0_Pin SD_D1_Pin
  ...
  /*Configure GPIO pins : BUTTON1_Pin ECON_Pin RECUPERATION_Pin */
  GPIO_InitStruct.Pin = BUTTON1_Pin|ECON_Pin|RECUPERATION_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

  /*Configure GPIO pins : OELDRUCK_Pin BC_DOWN_OUT_Pin BC_UP_OUT_Pin BC_RESET_OUT_Pin
  ...
  /*Configure GPIO pins : SPI5_CS_Pin SPI5_SCK_Pin SPI5_MISO_Pin SPI5_MOSI_Pin
                           PF10 */
  ...
  /*Configure GPIO pins : CRASH_Pin EMERGENCY_RUN_Pin HW_WAKE_Pin OUTA_Pin
  ...
  /*Configure GPIO pins : RED_LED_Pin F54_Pin F18_Pin KLIMA_OUT_Pin
  ...
  /*Configure GPIO pins : DCDC_INSTRUCTION_Pin DCDC_FAULT_Pin ASR_IN1_Pin GRA1_Pin
  ...
  /*Configure GPIO pins : SENSE_SDC_BTB_Pin BAMOCAR_IN2_Pin */
  GPIO_InitStruct.Pin = SENSE_SDC_BTB_Pin|BAMOCAR_IN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : KL15_Pin ANLASSER_Pin BAMOCAR_IN1_Pin ASR_IN2_Pin */
  GPIO_InitStruct.Pin = KL15_Pin|ANLASSER_Pin|BAMOCAR_IN1_Pin|ASR_IN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : BREMSLICHT_Pin RUECKFAHRLICHT_Pin KLIMA_PWM_Pin ANHAENGER_Pin
  ...
  /*Configure GPIO pins : BUZZER_Pin GENERATOR_LED_Pin WISCHWARNUNG_Pin BREMSWARNUNG_Pin
  ...
  /*Configure GPIO pin : OELSTAND_TEMP_Pin */
  ...
  /*Configure GPIO pins : CAN2_TX_Pin CAN2_RX_Pin I2C1_SCL_Pin I2C1_SDA_Pin */
